...
public class CouponDto implements Serializable {
    ...
    @NotNull(groups = {UpaCouponDto.class},message = "优惠券主键id不能为空")
    private Long id;

    @ApiModelProperty(value = "登陆用户id(loginId)")
    @NotNull(groups = {SaveCouponDto.class,UpaCouponDto.class},message = "登陆用户id(loginId)不能为空")
    private Long loginId;

    @ApiModelProperty(value = "优惠券名称")
    @NotBlank(groups = {SaveCouponDto.class,UpaCouponDto.class},message = "优惠券名称不能为空")
    private String name;

    @ApiModelProperty(value = "优惠券类型 0：满减  1：直减  2：折扣")
    @NotNull(groups = {SaveCouponDto.class,UpaCouponDto.class},message = "优惠券类型不能为空")
    ...
    @NotNull(groups = {SaveCouponDto.class,UpaCouponDto.class},message = "发放张数不能为空")
    private Integer grantNum;

    @ApiModelProperty(value = "是否永久  0：否  1：是")
    @NotNull(groups = {SaveCouponDto.class,UpaCouponDto.class},message = "是否永久不能为空")
