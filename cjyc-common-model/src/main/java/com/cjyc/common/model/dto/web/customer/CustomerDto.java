...
public class CustomerDto implements Serializable {
    ...
    @NotBlank(groups = {SaveCustomerVo.class,UpdateCustomerVo.class},message = "客户名称不能为空")
    @ApiModelProperty(value = "客户名称",required = true)
    private String contactMan;

    @NotBlank(groups = {SaveCustomerVo.class,UpdateCustomerVo.class},message = "手机号不能为空")
