...
public enum OrderCarLogEnum {
    ...
    C_UNLOAD_CANCEL("取消卸车", "车辆取消卸车", "车辆取消卸车，操作人【{1}/{2}】", 40),
    C_IN_STORE("已入库", "车辆已在【{0}】入库", "车辆已在【{0}】入库，操作人【{1}/{2}】", 24),
    C_OUT_STORE("已出库", "车辆已在【{0}】出库", "车辆已在【{0}】出库，操作人【{1}/{2}】", 25),
    C_UNRELEASE_UNPAID("通知未支付不可交车", "通知未支付不可交车", "通知未支付不可交车", 110),
    C_RELEASE_UNPAID("通知未支付可交车", "车辆已允许交车", "车辆已允许交车", 111),
    C_UNRELEASE_PAID("通知已支付不可交车", "车辆已允许交车", "车辆已允许交车", 112),
    C_RELEASE_PAID("通知已支付可交车", "车辆已允许交车", "车辆已允许交车", 119),
