...
public class LineExportExcel implements Serializable {
    ...
    @Excel(name = "物流费(元)", orderNum = "4", width = 15, type = 10)
    private BigDecimal defaultWlFee;

    @Excel(name = "运费(元)", orderNum = "5", width = 15, type = 10)
    private BigDecimal defaultFreightFee;

    @Excel(name = "总里程(km)", orderNum = "6", width = 15, type = 10)
    private BigDecimal kilometer;

    @Excel(name = "总里程(天)", orderNum = "7", width = 15, type = 10)
