...
public class OperationLogAspect {
    ...
    @Pointcut("@annotation(com.cjyc.common.model.annotations.OperationLogNav)")
     ...
     * @throws Throwable
     */
    @Before("storyOperationLog() && @annotation(com.cjyc.common.model.annotations.OperationLogNav)")
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        /*logService.recordLog(new OperationLog(logId.get(),token,account, ip, methodType, url, uri, clazz, methodName,
                LocalDateTimeUtil.formatLDTNow(TimePatternConstant.DATETIME), params));*/
    }
