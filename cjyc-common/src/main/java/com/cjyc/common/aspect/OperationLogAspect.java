...
public class OperationLogAspect {
    ...
    @Pointcut("@annotation(com.cjyc.common.annotations.OperationLogNav)")
     ...
     * @throws Throwable
     */
    @Before("storyOperationLog() && @annotation(com.cjyc.common.annotations.OperationLogNav)")
