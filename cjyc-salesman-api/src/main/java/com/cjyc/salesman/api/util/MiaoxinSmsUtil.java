...
import com.cjyc.salesman.api.config.MiaoxinProperty;
...
public class MiaoxinSmsUtil {
    ...
    /**你的短信子账号App_ID（非登陆账号）*/
    private final String ACCOUNT = MiaoxinProperty.account;
    /**你的短信子账号的App_SECRET 密匙（非登陆密码）*/
    private final String SECRET = MiaoxinProperty.secret;

    private final String SERVER = MiaoxinProperty.server;
     ...
     * @throws IOException
     */
    public String send(String mobiles, String content) throws IOException {
     ...
     * @throws IOException
     */
    private String request(String interfaceName, String account, String secret, Map<String, Object> params) throws IOException {
     ...
     * @throws IOException
     */
    private String post(String action, Map<String, Object> params, String encoding) throws IOException {
        if (params.isEmpty()) {
     ...
     * @throws IOException
     */
    private String post(String action, String content, int timeout4Connect, int timeout4Read) throws IOException {
