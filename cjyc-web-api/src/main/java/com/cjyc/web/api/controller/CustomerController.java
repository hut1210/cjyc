...
public class CustomerController {
    ...
    public ResultVo saveCustomer(@Validated({ CustomerDto.SaveCustomerVo.class }) @RequestBody CustomerDto customerVo){
    ...
    public ResultVo deleteCustomer(@RequestBody List<Long> arrIds){
    ...
    @PostMapping(value = "/deleteKeyCustomer")
    ...
    public ResultVo<ShowKeyCustomerVo> showKeyCustomerById(@PathVariable Long id){
        ShowKeyCustomerVo vo = iCustomerService.showKeyCustomerById(id);
    ...
    public ResultVo updateKeyCustomer(@Validated({ KeyCustomerDto.UpdateKeyCustomerVo.class }) @RequestBody KeyCustomerDto customerVo){
