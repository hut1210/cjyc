...
public class WaybillController {
     ...
     */
    @ApiOperation("提车调度")
    @PostMapping("/pick/dispatch/{userId}")
    public ResultVo<ListVo<BaseTipVo>> pickDispatch(@RequestBody WaybillPickDispatchListDto reqDto) {
        return waybillService.pickDispatch(reqDto);
    }
     ...
     */
    @ApiOperation("干线调度")
    @PostMapping("/trunk/dispatch/{userId}")
    public ResultVo<ListVo<BaseListTipVo>> trunkDispatch(@RequestBody WaybillTrunkDispatchListListDto reqDto) {
