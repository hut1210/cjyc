...
public class LineServiceImpl extends ServiceImpl<ILineDao, Line> implements ILineService {
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(lineImportExcelList)) {
                ...
                for (LineImportExcel lineExcel : lineImportExcelList) {
                    ...
                    Line line = encapExcelLine(lineExcel,null, fromCity, toCity, loginId);
                    list.add(line);
                }
     ...
     * @return
     */
    private Line encapExcelLine(LineImportExcel lineExcel,SaveOrUpdateLineExcel excel,
                                City fromCity,City toCity,Long loginId){
        Line line = new Line();
        line.setFromProvince(fromCity.getParentName());
        line.setFromProvinceCode(fromCity.getParentCode());
        ...
        String fromCityLocation = null;
        String toCityLocation = null;
        if(lineExcel != null){
